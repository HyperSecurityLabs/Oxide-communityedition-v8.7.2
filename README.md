...
FP Reduction · Zero-Day ML Anomaly Engine · WAF Massacre · Headless DOM · Distributed Cluster · Burp Suite Integration · Module Isolation · 和色 Palette
...
[![ Release](https://img.shields.io/badge/FINAL-RELEASE-FFB11B?style=for-the-badge&labelColor=1A1A1A)](https://github.com/HyperSecurityLabs/oxide-communityedition-v8.7.2)
...
[![Thank You](https://img.shields.io/badge/%E3%81%82%E3%82%8A%E3%81%8C%E3%81%A8%E3%81%86-Thank_You-8B81C3?style=for-the-badge&labelColor=1A1A1A)](https://github.com/HyperSecurityLabs/oxide-communityedition-v8.7.2)
...
[![Scanner Modules](https://img.shields.io/badge/_Scanner_Modules-13_Engines-2E8B7A?style=for-the-badge&logo=github&logoColor=000&labelColor=E8F5E8)](https://github.com/HyperSecurityLabs/oxide-communityedition-v8.7.2)
...
|------|---------|---------|------|---------|---------|
| `--url` | required | Target(s) or file | `--modules` | `sqli,xss,lfi,fuzz` | `all` or comma-sep |
...
| `--threads` | 20 | Concurrent workers | `--duration` | 0 | Scan time limit (seconds) |
| `--active` | false | TCP fingerprinting | `--exploitation-level` | 75 | Aggression (1–100) |
...
### Module Isolation
- Default scan runs only 4 core vulnerability modules: `sqli, xss, lfi, fuzz`
- `--modules all` runs all 13 modules (full scan)
...
- **`--threads` default increased to 20** — faster concurrent scanning
