...
impl HtmlReport {
    ...
    pub fn generate_header(title: &str, target: &str, target_ip: &str, duration: &str, links_count: usize, modules: &[String]) -> String {
        format!(
            r#"<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .module-summary {{
            ...
            border-left: 3px solid rgba(46, 169, 223, 0.5);
            border-radius: 4px;
        }}
        .module-summary .label {{
            font-size: 11px;
            color: rgba(145, 152, 159, 0.9);
            text-transform: uppercase;
            letter-spacing: 1px;
            margin-bottom: 6px;
        }}
...
<div class="container">
    <div class="header">
        ...
        <div class="version">v8.7.2-community-edition  //  hypersecurity_offsec</div>
    </div>
    <div class="meta-grid">
        <div class="meta-card">
        ...
        <div class="meta-card">
            ...
            <div class="value">{module_count} active</div>
        </div>
    </div>
    <div class="module-summary">
        <div class="label">Scan Modules:</div>
        <div class="module-tags">{module_tags}</div>
    </div>
"#,
            title = title,
            target = target,
            ...
            module_tags = modules.iter()
                .map(|m| format!("<span class=\"module-tag\">{}</span>", m))
                .collect::<Vec<_>>()
                .join(""),
        )
    }
...
<table>
    ...
    pub fn generate_footer() -> String {
        r#"
    <footer>
        <p>Generated by OXIDE Community Edition v8.7.2-community-edition</p>
